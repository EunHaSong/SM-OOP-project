...
public class RS extends JFrame {
    ...
    public RS(String msg) {
        ...
        // 절대 경로 설정 (각각의 다른 메뉴) -> 데이터베이스 따로 만들 예정
        String[] imagePaths = {
            "path/to/item1.jpg", "path/to/item2.jpg", "path/to/item3.jpg",
            "path/to/item4.jpg", "path/to/item5.jpg", "path/to/item6.jpg",
            "path/to/item7.jpg", "path/to/item8.jpg", "path/to/item9.jpg",
            "path/to/item10.jpg", "path/to/item11.jpg", "path/to/item12.jpg"
        };
        ...
        for (int i = 1; i <= 12; i++) {
            ...
            // 개별적으로 이미지 설정
            ImageIcon itemIcon = new ImageIcon(imagePaths[i - 1]);
